...
// SQLite real (sql.js/WASM) en vez de simular cada consulta a mano: ver __mocks__/opSqliteSqlJsMock.js.
jest.mock('@op-engineering/op-sqlite', () => require('./__mocks__/opSqliteSqlJsMock'));
